...
Elementor form DB. With export option to CSV
...
= 1.7 =
* Tweak - Improved saving global forms
* Tweak - Better performance
* Bugs fix

= 1.6.3 =
* Fix - Add compatibility to Editor
* Bugs fix

= 1.6.2 =
* Fix - Showing empty fields

= 1.6.1 =
* Fix - Supports custom form ID
