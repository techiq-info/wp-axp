...
if ( !function_exists( 'wp_sir_get_settings' ) ) {
    ...
    {
        $default_sizes = array_filter( get_intermediate_image_sizes(),
            function ( $sizeName ) {
...
if ( !function_exists( 'wp_sir_is_processable' ) ) {
    ...
    function _wp_sir_is_processable( $attachment_id )
    {
        ...
        if ( $attachment->post_parent
            && in_array( get_post_type( $attachment->post_parent ), $processable_post_types,
                true ) ) {
            return true;
        }
    ...
    function wp_sir_is_term_image_upload()
    {
        ...
        return apply_filters( 'wp_sir_is_uploading_term_image', _wp_sir_is_uploading_term_image( $taxonomies ),
            $taxonomies );
    }
