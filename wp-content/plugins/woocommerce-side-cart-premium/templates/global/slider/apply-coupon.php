...
<div class="xoo-wsc-sl-heading">
	...
	<?php _e( 'הוסף קופון לעגלה', 'side-cart-woocommerce' ); ?>
</div>

<div class="xoo-wsc-sl-body">
	
	<form class="xoo-wsc-sl-apply-coupon">
		<input type="text" name="xoo-wsc-slcf-input" placeholder="<?php _e( 'הכניסו קוד קופון', 'side-cart-woocommerce' ); ?>">
		<button type="submit"><?php _e( 'שלח', 'side-cart-woocommerce' ); ?></button>
	</form>
		...
		<?php foreach ( $coupons as $coupon_data ): ?>
			...
			<div class="xoo-wsc-coupon-row">
				...
				<?php if( $section === 'valid' ): ?>
					<button class="xoo-wsc-coupon-apply-btn" value="<?php echo $coupon->get_code() ?>"><?php _e( 'Apply Coupon', 'side-cart-woocommerce' ); ?></button>
				<?php endif; ?>
			</div>
