...
$container = '<div class="xoo-wsc-sp-container xoo-wsc-sp-'.$style.'"><ul class="xoo-wsc-sp-slider">%s</ul></div>';
...
while ( $products->have_posts() ) : $products->the_post();
	...
	$product_name 		= $product_permalink && $showPLink ? sprintf( '<a href="%s">%s</a>', $product_permalink, $product->get_title() ) : $product->get_title();
