...
class Module extends Element_Pack_Module_Base {
	...
	public function contact_form() {
		...
		if ( $_SERVER['REQUEST_METHOD'] == 'POST' ) {
			...
			if(isset($result['show_recaptcha']) && $result['show_recaptcha'] == 'yes'){
			...
			if ($error == false ) {
				echo '<span class="bdt-text-success" data-redirect="'.$redirect_url.'" data-external="'.$is_external.'">' . $result . '</span>';
