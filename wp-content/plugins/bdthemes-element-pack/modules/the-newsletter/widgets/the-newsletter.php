                ...
                <form method="post" action="http://192.168.1.100/element-pack-dev/?na=s">
                    ...
                    <?php if( $settings['firstname_show'] == 'yes' ){ ?>
                        <div class="tnp-field tnp-field-firstname">
                            <label for="tnp-name"><?php echo esc_html('First name or full name', 'ultimate-post-kit') ?></label>
                    ...
                    <?php if( $settings['lastname_show'] == 'yes' ){ ?>
                        <div class="tnp-field tnp-field-surname">
                            <label for="tnp-surname"><?php echo esc_html('Last name', 'ultimate-post-kit') ?></label>
                            <input class="tnp-surname" type="text" name="ns" value="">
                        </div>
                    <?php } ?>

                    <div class="tnp-field tnp-field-email">
                        <label for="tnp-email"><?php echo esc_html('Email', 'ultimate-post-kit') ?></label> 
