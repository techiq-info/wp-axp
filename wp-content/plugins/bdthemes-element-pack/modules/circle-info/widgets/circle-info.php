...
class Circle_Info extends Module_Base
{
    ...
    protected function _register_controls()
    {
		...
		$this->add_control(
            ...
            [
                ...
                'selectors'   => [
                    '{{WRAPPER}} .bdt-circle-info .bdt-circle-info-content-wrapper' => 'backdrop-filter: blur({{SIZE}}px); -webkit-backdrop-filter: blur({{SIZE}}px);'
				],
				'condition' => [
         ...
         $this->add_group_control(
            ...
            [
                ...
                'selector'  => '{{WRAPPER}} .bdt-circle-info .bdt-circle-info-content-wrapper',
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'type'      => Controls_Manager::DIMENSIONS,
                'selectors' => [
                    '{{WRAPPER}} .bdt-circle-info .bdt-circle-info-content-wrapper' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%'],
                'selectors'  => [
                    '{{WRAPPER}} .bdt-circle-info .bdt-circle-info-content-wrapper' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label'     => __('Background', 'bdthemes-element-pack'),
                'types'     => ['classic', 'gradient'],
                'selector'  => '{{WRAPPER}} .bdt-circle-info .bdt-circle-info-content-wrapper:hover',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .bdt-circle-info .bdt-circle-info-content-wrapper:hover' => 'border-color: {{VALUE}};',
                ],
            ]
        );
    ...
    protected function render()
    {
        ...
        $this->add_render_attribute( 'circle_info', 'class', 'bdt-circle-info' );
            ...
            <div class="bdt-circle-info-wrapper" id="<?php echo 'bdt-circle-info-' . $this->get_id(); ?>">
                ...
                <div class="bdt-circle-info-content-wrapper">
                    ...
                    foreach ($settings['circle_info_icon_list'] as $index => $item):
                        ...
                        // print_r($this->get_render_attribute_string($link_key)); exit();
