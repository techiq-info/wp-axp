 ...
 * @package     Order-Delivery-Date-Pro-for-WooCommerce/Templates/Emails/Plain/Admin-Update-Date
 * @since       5.7
 */
...
if( $delivery_date_formatted != '' ) {
   echo '<p><strong>' . __( get_option( 'orddd_delivery_date_field_label' ), 'order-delivery-date' ) . ':</strong> ' . $delivery_date_formatted . '</p>';
}
