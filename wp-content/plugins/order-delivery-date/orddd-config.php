...
define( 'ORDDD_DELIVERY_ESTIMATE_TEXT' ,          'Your Estimated shipping date for the order is %shipping_date%.
The delivery will take approximately <strong>%delivery_range_start_days% - %delivery_range_end_days%</strong> working days from the shipping days.' );
