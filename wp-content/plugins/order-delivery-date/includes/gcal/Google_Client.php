...
if (file_exists(dirname(__FILE__)  . '/local_config.php')) {
  $defaultConfig = $Orddd_apiConfig;
  require_once (dirname(__FILE__)  . '/local_config.php');
  $Orddd_apiConfig = array_merge($defaultConfig, $Orddd_apiConfig);
}
...
class Google_Client {
  ...
  public function __construct($config = array()) {
    global $Orddd_apiConfig;
    $Orddd_apiConfig = array_merge($Orddd_apiConfig, $config);
    self::$cache = new $Orddd_apiConfig['cacheClass']();
    self::$auth = new $Orddd_apiConfig['authClass']();
    self::$io = new $Orddd_apiConfig['ioClass']();
  }
  ...
  public function addService($service, $version = false) {
    ...
    if (isset($Orddd_apiConfig['services'][$service])) {
      // Merge the service descriptor with the default values
      $this->services[$service] = array_merge($this->services[$service], $Orddd_apiConfig['services'][$service]);
    }
  }
  ...
  public function setApplicationName($applicationName) {
    global $Orddd_apiConfig;
    $Orddd_apiConfig['application_name'] = $applicationName;
  }
  ...
  public function setClientId($clientId) {
    global $Orddd_apiConfig;
    $Orddd_apiConfig['oauth2_client_id'] = $clientId;
  ...
  public function setClientSecret($clientSecret) {
    global $Orddd_apiConfig;
    $Orddd_apiConfig['oauth2_client_secret'] = $clientSecret;
  ...
  public function setRedirectUri($redirectUri) {
    global $Orddd_apiConfig;
    $Orddd_apiConfig['oauth2_redirect_uri'] = $redirectUri;
  ...
  public function setUseObjects($useObjects) {
    global $Orddd_apiConfig;
    $Orddd_apiConfig['use_objects'] = $useObjects;
  }
