...
class Orddd_Google_Config
{
  ...
  public function __construct($ini_file_location = null)
  {
    $this->configuration = array(
      ...
      'auth_class'    => 'Orddd_Google_Auth_OAuth2',
      'io_class'      => self::USE_AUTO_IO_SELECTION,
      'cache_class'   => 'Orddd_Google_Cache_File',
      'logger_class'  => 'Orddd_Google_Logger_Null',
      ...
      'classes' => array(
        'Orddd_Google_IO_Abstract' => array(
          'request_timeout_seconds' => 100,
        ),
        'Orddd_Google_Logger_Abstract' => array(
          'level' => 'debug',
          'log_format' => "[%datetime%] %level%: %message% %context%\n",
          'date_format' => 'd/M/Y:H:i:s O',
          'allow_newlines' => true
        ),
        'Orddd_Google_Logger_File' => array(
          'file' => 'php://stdout',
          'mode' => 0640,
          'lock' => false,
        ),
        'Orddd_Google_Http_Request' => array(
        ...
        'Orddd_Google_Auth_OAuth2' => array(
        ...
        'Orddd_Google_Task_Runner' => array(
        ...
        'Orddd_Google_Service_Exception' => array(
          'retry_map' => array(
        ...
        'Orddd_Google_IO_Exception' => array(
        ...
        'Orddd_Google_Cache_File' => array(
          'directory' => sys_get_temp_dir() . '/Orddd_Google_Client'
        )
      ),
    );
