 ...
 */
class Orddd_Google_Cache_Memcache extends Orddd_Google_Cache_Abstract
{
  ...
  public function __construct(Orddd_Google_Client $client)
  {
    if (!function_exists('memcache_connect') && !class_exists("Memcached")) {
      ...
      throw new Orddd_Google_Cache_Exception($error);
    }
  ...
  public function set($key, $value)
  {
    ...
    if ($rc == false) {
      ...
      throw new Orddd_Google_Cache_Exception("Couldn't store data in cache");
    }
