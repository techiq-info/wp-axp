 ...
 */
class Orddd_Google_Logger_Psr extends Orddd_Google_Logger_Abstract
{
  /**
   ...
   */
  public function __construct(Orddd_Google_Client $client, /*Psr\Log\LoggerInterface*/ $logger = null)
  {
