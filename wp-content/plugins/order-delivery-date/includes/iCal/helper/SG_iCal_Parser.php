...
class SG_iCal_Parser {
	 ...
	 * @param string $url
	 * @param SG_Orddd_iCal $ical
	 */
	public static function Parse( $url, SG_Orddd_iCal $ical ) {
	 ...
	 * @param SG_Orddd_iCal $ical
	 */
	public static function ParseString($content, SG_Orddd_iCal $ical ) {
		$content = self::UnfoldLines($content);
		self::_Parse( $content, $ical );
	}
	 ...
	 * @param SG_Orddd_iCal $ical
	 */
	private static function _Parse( $content, SG_Orddd_iCal $ical ) {
	...
	/**
	 * Stores the data in provided SG_Orddd_iCal object
	 * @param string $section eg 'vcalender', 'vevent' etc
	 * @param string $data
	 * @param SG_Orddd_iCal $ical
	 */
	protected static function storeSection( $section, $data, SG_Orddd_iCal $ical ) {
