...
class SG_iCal_VEvent {
	...
	/**
	 * Constructs a new SG_iCal_VEvent. Needs the SG_Orddd_iCalReader
	 * supplied so it can query for timezones.
	 * @param SG_iCal_Line[] $data
	 * @param SG_Orddd_iCalReader $ical
	 */
	public function __construct($data, SG_Orddd_iCal $ical) {
	 ...
	 * @return int
	 */
	protected function getTimestamp( SG_iCal_Line $line, SG_Orddd_iCal $ical ) {
