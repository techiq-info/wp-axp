...
define('SG_Orddd_iCalReader_VERSION', '0.7.0');
 ...
 * A simple example:
 * <?php
 * $ical = new SG_Orddd_iCalReader("http://example.com/calendar.ics");
...
/**
 * For legacy reasons, we keep the name SG_Orddd_iCalReader..
 */
class SG_Orddd_iCalReader extends SG_Orddd_iCal {}
