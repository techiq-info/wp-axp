		...
		public function register_controls( $manager ) {
			...
			$manager->add_control(
				...
				array(
					...
					'description'  => esc_html__( 'This options works only with Products Grid, Product List, Archive Add to Cart widgets and open popup after product added to cart.', 'jet-woo-builder' ),
					'type'         => Elementor\Controls_Manager::SWITCHER,
